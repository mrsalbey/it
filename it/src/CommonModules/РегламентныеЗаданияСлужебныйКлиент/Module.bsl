...
Процедура ПриНачалеРаботыСистемы() Экспорт
	...
	ИначеЕсли ПараметрыРаботыКлиента.ИнформационнаяБазаФайловаяБезМенеджераФоновыхЗаданий Тогда
		...
		////ПараметрыТолькоЧтение = ПараметрыРаботыКлиента.ПараметрыЗапускаОтдельногоСеансаВыполненияРегламентныхЗаданий; 	//Комиссаров: 23/08/2013 - закамментил для отладки в файловом режиме
		////
