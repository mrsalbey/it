...
Процедура ПолучитьПрефиксообразующиеРеквизиты(Объекты) Экспорт
	...
	СтрокаТаблицы = Объекты.Добавить();
	СтрокаТаблицы.Объект = Метаданные.Документы.ПоступлениеОС;
	СтрокаТаблицы.Реквизит = "Организация";
	
	СтрокаТаблицы = Объекты.Добавить();
	СтрокаТаблицы.Объект = Метаданные.Документы.ПеремещениеОС;
	СтрокаТаблицы.Реквизит = "Организация";
	
	СтрокаТаблицы = Объекты.Добавить();
	СтрокаТаблицы.Объект = Метаданные.Документы.РаспределениеЛицензий;
	СтрокаТаблицы.Реквизит = "Организация";
