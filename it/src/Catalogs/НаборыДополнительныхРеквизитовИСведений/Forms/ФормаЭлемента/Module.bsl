...
Процедура ЗаполнитьИспользованиеДополнительныхСвойств()
	...
	ПоказыватьДопРеквизиты = ИспользоватьДопРеквизиты И НЕ Параметры.СкрытьДополнительныеРеквизиты;
	ПоказыватьДопСведения  = ИспользоватьДопСведения  И НЕ Параметры.СкрытьДополнительныеСведения;
	
	Если НЕ ПоказыватьДопРеквизиты Тогда
	...
	ИначеЕсли НЕ ПоказыватьДопСведения Тогда
...
Процедура ЗаполнитьДополнительныеСвойстваВФорме()
	...
	Если ПоказыватьДопРеквизиты Тогда
...
Процедура ЗаполнитьДополнительныеСвойстваВОбъекте(ТекущийОбъект)
	...
	Если ПоказыватьДопРеквизиты ИЛИ НЕ ИспользоватьДопРеквизиты Тогда
		ТекущийОбъект.ДополнительныеРеквизиты.Очистить();
	КонецЕсли;
	
	Если ПоказыватьДопСведения ИЛИ НЕ ИспользоватьДопСведения Тогда
