...
Процедура ОбновитьПометкиКнопокКоманднойПанели();
	...
	// Шрифт
	Шрифт = Область.Шрифт;
	Элементы.Полужирный.Пометка = Шрифт <> Неопределено И Шрифт.Жирный;
	Элементы.Курсив.Пометка = Шрифт <> Неопределено И Шрифт.Наклонный;
	Элементы.Подчеркивание.Пометка = Шрифт <> Неопределено И Шрифт.Подчеркивание;
	Элементы.Зачеркивание.Пометка = Шрифт <> Неопределено И Шрифт.Зачеркивание;
	...
	//
	//Элементы.ГраницаСверху.Пометка = Область.ГраницаСверху = ОбычнаяЛиния;
	//Элементы.ГраницаСлева.Пометка = Область.ГраницаСлева = ОбычнаяЛиния;
	//Элементы.ГраницаСнизу.Пометка = Область.ГраницаСнизу = ОбычнаяЛиния;
	//Элементы.ГраницаСправа.Пометка = Область.ГраницаСправа = ОбычнаяЛиния;
	//
	//Элементы.ТолстаяГраницаСверху.Пометка = Область.ГраницаСверху = ТолстаяЛиния;
	//Элементы.ТолстаяГраницаСнизу.Пометка = Область.ГраницаСнизу = ТолстаяЛиния;
