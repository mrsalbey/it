...
Процедура ПодготовитьТаблицыДокумента() Экспорт
	...
	ДополнительныеСвойства.ТаблицыДляДвижений.Вставить("ТаблицаРаспределениеЛицензий", Документы.РаспределениеЛицензий.ПолучитьТаблицуРаспределениеЛицензий(ДополнительныеСвойства));
	ДополнительныеСвойства.ТаблицыДляДвижений.Вставить("ТаблицаЛицензииОрганизации", Документы.РаспределениеЛицензий.ПолучитьТаблицуЛицензииОрганизации(ДополнительныеСвойства));
...
Функция ВременныеТаблицыДанныхДокумента() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	РаспределениеЛицензийОсновныеСредства.ИдентификаторУстановлено,
	               |	СУММА(РаспределениеЛицензийОсновныеСредства.Количество) КАК Количество
