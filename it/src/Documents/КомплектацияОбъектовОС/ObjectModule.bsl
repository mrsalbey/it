...
Процедура ПодготовитьТаблицыДокумента() Экспорт
	...
	ДополнительныеСвойства.ТаблицыДляДвижений.Вставить("ТаблицаРазмещениеОбъектов", Документы.КомплектацияОбъектовОС.ПолучитьТаблицуОбъектыВСоставеОС(ДополнительныеСвойства));
...
Функция ВременныеТаблицыДанныхДокумента() Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ГДЕ
	               |	КомплектацияОбъектовОСОсновныеСредства.Ссылка = &Ссылка";
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	КлючевыеРеквизиты.Добавить("Объект");
	КлючевыеРеквизиты.Добавить("КлючСвязи");
	ЗаполнениеДокументовСервер.ПроверитьНаличиеДублейСтрокТЧ(ЭтотОбъект, "Комплектующие", КлючевыеРеквизиты, Отказ,, Истина);
